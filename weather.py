...
def weatherURL():
    ...
    # This is used as rain probability isn't always given

    if 'precipProbability' in json_data['hourly']['data'][0]:
    ...
    ## sometimes the rain probability is not given hence an if statement ##

    if 'precipProbability' in json_data['hourly']['data'][0]:
        rain_prob2 = json_data['hourly']['data'][0]['precipProbability']
        rain_prob2_percentage = rain_prob2 * 100
    else:
        rain_prob2_percentage = None
    ...
    if rain_prob1_percentage != None and rain_prob2_percentage != None and rain_prob3_percentage != None:
